...
{
  if( workspaceObject.iddObject().type() != iddobjectname::Shading_Site_Detailed ){
  ...
  BOOST_FOREACH(const ShadingSurfaceGroup& group, m_model.getConcreteModelObjects<ShadingSurfaceGroup>()){
