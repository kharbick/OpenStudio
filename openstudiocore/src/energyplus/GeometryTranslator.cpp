...
namespace energyplus {
  ...
  bool GeometryTranslator::convertSimpleShading(const CoordinateChange& coordChange)
  {
    ...
    // Shading::Site
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Site)){
    ...
    // Shading::Building
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Building)){
    ...
    // Shading:Overhang
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Overhang)){
    ...
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Overhang_Projection)){
    ...
    // Shading:Fin
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Fin)){
    ...
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Shading_Fin_Projection)){
  ...
  {
    // Window
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Window)){
    ...
    // Door
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Door)){
    ...
    // GlazedDoor
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::GlazedDoor)){
    ...
    // Window:Interzone
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Window_Interzone)){
    ...
    // Door:Interzone
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Door_Interzone)){
    ...
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::GlazedDoor_Interzone)){
  ...
  bool GeometryTranslator::convertSimpleSurfaces(const CoordinateChange& coordChange)
  {
    ...
    // Wall::Detailed
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Wall_Detailed)){
    ...
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::RoofCeiling_Detailed)){
    ...
    // Floor::Detailed
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Floor_Detailed)){
    ...
    // Wall:Exterior
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Wall_Exterior)){
    ...
    // Wall:Adiabatic
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Wall_Adiabatic)){
    ...
    // Wall:Underground
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Wall_Underground)){
    ...
    // Wall:Interzone
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Wall_Interzone)){
    ...
    // Roof
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Roof)){
    ...
    // Ceiling:Adiabatic
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Ceiling_Adiabatic)){
    ...
    // Ceiling:Interzone
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Ceiling_Interzone)){
    ...
    // Floor:GroundContact
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Floor_GroundContact)){
    ...
    // Floor:Adiabatic
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Floor_Adiabatic)){
    ...
    // Floor:Interzone
    for (WorkspaceObject oldObject : m_workspace.getObjectsByType(iddobjectname::Floor_Interzone)){
  ...
  bool GeometryTranslator::convertDaylightingGeometry(const CoordinateChange& daylightingCoordChange)
  {
    ...
    for (WorkspaceObject daylightingControl : m_workspace.getObjectsByType(iddobjectname::Daylighting_Controls)){
    ...
    for (WorkspaceObject illuminanceMap : m_workspace.getObjectsByType(iddobjectname::Output_IlluminanceMap)){
      if (daylightingCoordChange != CoordinateChange::NoChange){
  ...
  bool GeometryTranslator::convertDetailedGeometry(const CoordinateChange& detailedCoordChange)
  {
    ...
    for (WorkspaceObject surface : m_workspace.getObjectsByType(iddobjectname::BuildingSurface_Detailed)){
    ...
    for (WorkspaceObject subsurface : m_workspace.getObjectsByType(iddobjectname::FenestrationSurface_Detailed)){
    ...
    for (WorkspaceObject zoneShading : m_workspace.getObjectsByType(iddobjectname::Shading_Zone_Detailed)){
    ...
    for (WorkspaceObject buildingShading : m_workspace.getObjectsByType(iddobjectname::Shading_Building_Detailed)){
    ...
    for (WorkspaceObject siteShading : m_workspace.getObjectsByType(iddobjectname::Shading_Site_Detailed)){
  ...
  bool GeometryTranslator::reverseAllDetailedVertices()
  {
    ...
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::BuildingSurface_Detailed)){
    ...
    // Wall:Detailed
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::Wall_Detailed)){
    ...
    // RoofCeiling:Detailed
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::RoofCeiling_Detailed)){
    ...
    // Floor:Detailed
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::Floor_Detailed)){
    ...
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::FenestrationSurface_Detailed)){
    ...
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::Shading_Site_Detailed)){
    ...
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::Shading_Building_Detailed)){
    ...
    for (WorkspaceObject object : m_workspace.getObjectsByType(iddobjectname::Shading_Zone_Detailed)){
